...
public class CustomerHypermediaRestController {
    ...
    ResponseEntity<CollectionModel<EntityModel<Customer>>> getCollection() {
        List<EntityModel<Customer>> collect = customerRepository.findAll().stream()
    ...
    ResponseEntity<EntityModel<Customer>> put(@PathVariable Long id, @RequestBody Customer c) {
